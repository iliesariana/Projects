...
class RentalService:
    ...
    def __default_rentals(self, j):
        ...
        while True:
            ...
            c_id = c.id
            random_rent_date = self.__random_date(datetime.date(2023, 1, 1))
    ...
    def add_rental(self, book_id, cl_id, rent_date=datetime.date.today(), returned_date='-'):
        ...
        UndoManager.register_operation(self.__repo, UndoHandler.ADD_RENTAL, new_rent,self.__b_repo)
